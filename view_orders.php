  ...
  <section >
    ...
    <div class="border-3 one card" >
      ...
      <div class="card-body" >
        ...
        <a href="view_orders_details.php?id=<?php echo $row['user_id'];?>" class="btn btn-primary">Details</a>
        <a href="view_user.php?id=<?php echo $row['user_id'];?>" class="btn btn-warning">user</a>
        <a href="remove_order.php?id=<?php echo $row['o_id'];?>" class="btn btn-danger">Cancel</a>
