...
if(isset($_POST['submit'])){
  ...
  $sql=mysqli_query($conn,"INSERT INTO Packages(p_image,p_image1,p_image2,p_name,country,state,p_description) VALUES('$image','$image1','$image2','$name','$country','$state','$description')");
  if($sql)
  {
