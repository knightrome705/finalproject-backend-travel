...
$data=mysqli_query($conn,"SELECT users.user_id,users.first_name,users.last_name,feedback.f_id,feedback.feedback,feedback.initial_date,feedback.final_date,feedback.reply FROM feedback INNER JOIN users ON users.user_id=feedback.user_id ORDER by final_date DESC;");
?>
