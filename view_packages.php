...
<div class="one card" style="width: 20rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><?php echo $row['p_description'];?>days</p>
    <a href="update_packages.php?id=<?php echo $row['p_id'];?>" class="btn btn-primary">Edit</a>
    <a href="remove_packages.php?id=<?php echo $row['p_id'];?>" class="btn btn-danger">Delete</a>
  </div>
</div>
</div>
  </div>
