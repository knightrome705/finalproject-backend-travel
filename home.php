    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Modern pathways help tourists achieve dream travel.</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Dive into extraordinary experiences with our tours. Uncover hidden gems and create timeless memories on your next adventure.</h2>
    ...
    <section id="values" class="values">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          ...
          <p>From the begining to the end</p>
        </header>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              ...
              <h3>Bookinging from anywhere</h3>
